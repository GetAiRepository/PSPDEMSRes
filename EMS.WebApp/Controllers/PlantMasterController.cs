...
namespace EMS.WebApp.Controllers
{
    ...
    public class PlantMasterController : Controller
    {
        ...
        public PlantMasterController(IPlantMasterRepository repo, IMemoryCache cache)
        {
            _repo = repo;
            _cache = cache;
        }
        ...
        public IActionResult Create() => PartialView("_CreateEdit", new org_plant());

        [HttpPost]
        public async Task<IActionResult> Create(org_plant model)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(org_plant model)
        {
            try
            {
                // Sanitize input before processing
        ...
        private org_plant SanitizeInput(org_plant model)
        {
        ...
        private bool IsInputSecure(org_plant model)
        {
